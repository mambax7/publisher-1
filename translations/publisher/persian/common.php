...
define("_CO_PUBLISHER_DATESUB","تاریخ انتشار");
...
//define("_CO_PUBLISHER_OPTIONS","انتخاب‌ها");
...
define("_CO_PUBLISHER_EDIT","ویرایش خبر");
define("_CO_PUBLISHER_CLONE","Duplicate article");
define("_CO_PUBLISHER_ADD_FILE","اضافه کردن فایل");
...
define("_CO_PUBLISHER_INTITEMFOUND","این یک خبر جالب است که در %s پیدا کردم");
define("_CO_PUBLISHER_POSTEDBY","Published by %s on %s");
define("_CO_PUBLISHER_BODY","متن");
define("_CO_PUBLISHER_BODY_DSC","Article's body");
define("_CO_PUBLISHER_CATEGORY","شاخه");
...
define("_CO_PUBLISHER_TITLE","عنوان");
define("_CO_PUBLISHER_SUBTITLE","Sub title");
define("_CO_PUBLISHER_ERROR","Sorry, some error occurred!");
define("_CO_PUBLISHER_SORTBY","مرتب سازی بر اساس ");
define("_CO_PUBLISHER_ADD","اضافه‌کردن");
define("_CO_PUBLISHER_REMOVE","حذف");
define("_CO_PUBLISHER_PREVIEW","پیش‌نمایش");
define("_CO_PUBLISHER_CREATE","Create");
define("_CO_PUBLISHER_CLEAR","پاک کردن گزینه ها");
define("_CO_PUBLISHER_CANCEL","انصراف");
...
define("_CO_PUBLISHER_TAB_MAIN","اصلی");
define("_CO_PUBLISHER_TAB_IMAGES","تصوير");
define("_CO_PUBLISHER_TAB_OTHERS","Others");
define("_CO_PUBLISHER_TAB_META","Meta data");
define("_CO_PUBLISHER_TAB_PERMISSIONS","دسترسی ها");
...
//30/04/2012
define("_CO_PUBLISHER_TAB_FILES","فایل");
define("_CO_PUBLISHER_FILE","فایل");
define("_CO_PUBLISHER_FILE_DESCRIPTION","شرح");
